...
export function buildBrandingTokens(settings: BrandingSettings): BrandingRuntimeTokens {
  ...
  return {
    ...
    layout: {
      ...
      loginBackgroundImageUrls: settings.loginBackgroundImageUrls,
      loginImageUrls: settings.loginImageUrls,
      loginOverlayColor,
      loginOverlayOpacity,
    },
    assets: {
    ...
    text: {
      ...
      imageWelcomeMessage: settings.imageWelcomeMessage,
      imageWelcomeMessages: settings.imageWelcomeMessages,
      imageLoginHeadline: settings.imageLoginHeadline,
      imageLoginSupportMessage: settings.imageLoginSupportMessage,
      ...
      visibility: {
        ...
        imageWelcomeMessage: settings.showImageWelcomeMessage,
        imageLoginHeadline: settings.showImageLoginHeadline,
        imageLoginSupportMessage: settings.showImageLoginSupportMessage,
