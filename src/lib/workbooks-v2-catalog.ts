...
export const WORKBOOKS_V2_CATALOG: WorkbookV2CatalogItem[] = [
    ...
    },
    {
        ...
        statusLabel: 'V3 — escritura, voz e IA',
        progress: 100,
        summary: 'Workbook V3 final del programa con escritura y grabación por voz, transcripción automática y análisis IA. Integra visión a 3 años, mapa integral de vida, PDI, plan 12 meses y Executive Growth Plan.',
        isImplemented: true,
    },
];
