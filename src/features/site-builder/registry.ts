...
export const BLOCK_DEFINITIONS: BlockDefinition[] = [
  ...
  def({
    ...
    fields: [
      ...
      { key: 'diagBullets', label: 'Diagnóstico · Beneficios (uno por línea)', type: 'textarea' },
      { key: 'diagCardText', label: 'Diagnóstico · Texto de la tarjeta', type: 'textarea' },
      { key: 'diagCardNote', label: 'Diagnóstico · Nota de la tarjeta', type: 'textarea' },
      { key: 'diagUnavailable', label: 'Diagnóstico · Mensaje sin disponibilidad', type: 'textarea' },
      { key: 'programsDescription', label: 'Programas · Descripción', type: 'textarea' },
      { key: 'programsUnavailable', label: 'Programas · Mensaje sin disponibilidad', type: 'textarea' },
      { key: 'programsPriceNote', label: 'Programas · Nota de precio', type: 'text' },
      { key: 'mentoriasDescription', label: 'Mentorías · Descripción', type: 'textarea' },
      { key: 'mentoriasUnavailable', label: 'Mentorías · Mensaje sin disponibilidad', type: 'textarea' },
      { key: 'mentoriasFootnote', label: 'Mentorías · Nota al pie', type: 'textarea' },
      { key: 'circuloDescription', label: 'Círculo · Descripción', type: 'textarea' },
      { key: 'circuloUnavailable', label: 'Círculo · Mensaje sin disponibilidad', type: 'textarea' },
    ],
    defaults: {
      kicker: '',
