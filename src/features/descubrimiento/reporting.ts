...
export function buildDiscoveryReport(
  ...
  return [
    ...
    "",
    "## Intervención táctica",
    `- Agenda una revisión semanal de 30 minutos para observar avances en ${listInline(gaps.slice(0, 2))}.`,
    `- Define una acción visible por semana y un criterio de éxito simple para no diluir el foco.`,
    `- Pide retroalimentación concreta a una persona de confianza sobre el cambio que estás practicando.`,
    "",
    "## Señal de progreso",
