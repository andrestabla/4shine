 ...
 * de /analyze murió) o `running` estancado, y regenera sus informes desde los
 * datos del diagnóstico. Lo usan el cron y, como respaldo, la carga del panel
 * admin de Descubrimiento (porque el cron de Vercel puede quedar bloqueado por
 * el redirect de dominio a www). Hace un claim atómico por job para no duplicar
 * trabajo entre invocaciones concurrentes. Procesa un lote pequeño por llamada.
 */
