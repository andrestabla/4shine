...
export const VARIABLE_DEFS: Record<VariableKey, VariableDef> = {
  ...
  adviser_nombre: {
    key: 'adviser_nombre',
    label: 'Nombre del Advisor',
    description: 'Nombre del mentor/advisor asignado',
    example: 'Carlos Ruiz',
  },
  lider_nombre: {
    key: 'lider_nombre',
  ...
  motivo: {
    ...
    example: 'El advisor tiene una emergencia personal.',
  },
  nueva_fecha: {
    key: 'nueva_fecha',
...
export const NOTIFICATION_EVENTS: NotificationEventDef[] = [
  ...
  },
  {
    ...
    moduleCode: 'mentorias',
    moduleLabel: 'Mentorías',
    label: 'Mentoría agendada (para el Advisor)',
    description: 'Se envía al advisor cuando un líder agenda una mentoría con él.',
  ...
  },
  {
    ...
    description: 'Se envía al líder cuando su mentoría es cancelada por el advisor.',
  ...
  },
  {
    ...
    moduleCode: 'mentorias',
    moduleLabel: 'Mentorías',
    label: 'Recordatorio de Expertos en vivo',
    description: 'Recordatorio automático antes de una sesión de Expertos en vivo, según las ventanas configuradas (72h/24h/12h/6h/3h/1h/30m).',
    variables: ['nombre', 'titulo', 'fecha', 'hora', 'enlace_sesion', 'tiempo_restante', 'plataforma'],
    defaultInAppType: 'info',
    windowsConfigurable: true,
  },
  {
    ...
    moduleCode: 'mentorias',
    moduleLabel: 'Mentorías',
    label: 'Inscripción a Expertos en vivo confirmada',
    description: 'Se envía cuando el líder se inscribe a una sesión de Expertos en vivo.',
  ...
  },
  {
    ...
    moduleCode: 'mentorias',
    moduleLabel: 'Mentorías',
    label: 'Nueva sesión de Expertos en vivo disponible',
    description: 'Se envía cuando se publica una nueva sesión de Expertos en vivo para inscripción.',
  ...
  {
    key: 'convocatorias.request_approved',
    moduleCode: 'convocatorias',
    moduleLabel: 'Convocatorias',
    label: 'Solicitud aprobada y publicada (para el líder)',
    description: 'Se envía al líder cuando el gestor aprueba su solicitud y la convocatoria queda publicada.',
    variables: ['nombre', 'titulo', 'plataforma', 'enlace_plataforma'],
    defaultInAppType: 'success',
  },
  {
    key: 'convocatorias.request_rejected',
    moduleCode: 'convocatorias',
    moduleLabel: 'Convocatorias',
    label: 'Solicitud rechazada (para el líder)',
    description: 'Se envía al líder cuando el gestor rechaza su solicitud de publicación. Puede incluir el motivo.',
    variables: ['nombre', 'titulo', 'motivo', 'plataforma', 'enlace_plataforma'],
    defaultInAppType: 'alert',
  },
  {
...
export function customEventToEventDef(ce: CustomEventRecord): NotificationEventDef {
  const variables = (ce.variables.length > 0
    ? ce.variables
    : ['nombre', 'nombre_completo', 'correo', 'plataforma', 'enlace_plataforma', 'fecha']) as VariableKey[];
  return {
    key: ce.eventKey,
