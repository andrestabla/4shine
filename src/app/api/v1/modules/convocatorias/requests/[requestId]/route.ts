...
import type { ReviewRequestInput, CreateRequestInput } from '@/features/convocatorias/service';
import { reviewRequest, updateRequest } from '@/features/convocatorias/service';
  ...
  try {
    const data = await withClient((client) =>
      withRoleContext(client, identity.userId, identity.role, async () => {
        const result = await updateRequest(client, identity, requestId, body);
        await logModuleAudit(client, request, identity, {
          moduleCode: 'convocatorias',
          action: 'update_convocatoria_request',
