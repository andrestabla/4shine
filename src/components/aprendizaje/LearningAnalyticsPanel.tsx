...
export function LearningAnalyticsPanel({ resources, totalAvailable }: LearningAnalyticsPanelProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
      <div className="flex flex-col justify-between rounded-[22px] border border-[var(--app-border)] bg-[var(--brand-surface)] p-5 shadow-[0_16px_36px_rgba(0,0,0,0.04)]">
      ...
      <div className="flex flex-col justify-between rounded-[22px] border border-[var(--app-border)] bg-white/80 p-5 shadow-[0_16px_36px_rgba(0,0,0,0.04)]">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--brand-surface-strong)] shadow-sm">
            <Layers3 size={18} style={{ color: 'var(--brand-primary)' }} />
          </div>
      ...
      <div className="flex flex-col justify-between rounded-[22px] border border-[var(--app-border)] bg-white/80 p-5 shadow-[0_16px_36px_rgba(0,0,0,0.04)]">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full shadow-sm" style={{ background: 'var(--brand-accent-soft)' }}>
            <MonitorPlay size={18} style={{ color: 'var(--brand-accent-strong)' }} />
          </div>
