...
const LEADER_EVALUATION_INSTRUCTIONS = [
    ...
    'Usa este bloque para acordar tu plan con el Adviser.'
]
                                ...
                                {(evaluationStage === 'mentor' || isExportingAll) && (
                                    <section className="space-y-5">
                                        ...
                                        <article className="rounded-2xl border border-slate-200 bg-slate-50 p-5 md:p-6 space-y-4">
                                            <div className="flex flex-wrap items-start justify-between gap-3">
                                                <h4 className="text-base font-bold text-slate-900">Panel de cierre Adviser</h4>
                                                <span
                                                    className={`inline-flex rounded-full border px-2.5 py-1 text-[11px] font-semibold ${
                                            ...
                                            <label className="block space-y-1">
                                                <span className="text-xs uppercase tracking-[0.12em] text-slate-500">
                                                    Observaciones generales del Adviser
                                                </span>
                                                <textarea
