...
const KPI_OWNER_OPTIONS = ['Yo', 'Equipo', 'Adviser', 'Marketing', 'Comercial', 'Operaciones'] as const
                            ...
                            >
                                <header className="space-y-2">
                                    ...
                                    <p className="text-sm md:text-base text-slate-700 max-w-4xl">
                                        Objetivo: permitir que Adviser y líder evalúen con evidencia, definan decisiones por criterio y cierren con
                                    ...
                                    <section className="space-y-5">
                                        <section className="rounded-2xl border border-slate-200 bg-slate-50 p-5 md:p-6 space-y-4">
                                            <div className="flex flex-wrap items-center justify-between gap-2">
                                                <h3 className="text-base md:text-lg font-bold text-slate-900">A) Instrucciones para el Adviser (rúbricas)</h3>
                                                <button
                                                    type="button"
                                                    ...
                                                    <article key={`wb8-mentor-row-${row.criterion}`} className="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
                                                        ...
                                                        {isEditing ? (
                                                            <div className="space-y-3">
                                                                ...
                                                                <fieldset className="space-y-2">
                                                                    <legend className="text-xs uppercase tracking-[0.12em] text-slate-500">Decisión del Adviser</legend>
                                                                    <div className="flex flex-wrap gap-2">
